...
const byte HASH_SIZE = 60;    //Hash Map defined for 60 characters
//storage 
...
char prevprev='\0';   // stores the character before the previous character
...
void sendunic(int val)
{
  ...
  //clear the buffer each time a new key has to be pressed
  ...
  prev='\0';
    ...
    TrinketKeyboard.pressKey(0,0);
       ...
       TrinketKeyboard.pressKey(0,KEYCODE_ARROW_RIGHT);
        ...
        else if((((prev=='k')&&(c=='k'))|| ((prev=='t')&&(c=='t'))||((prev=='m')&&(c=='m'))||((prev=='j')&&(c=='j'))||((prev=='n')&&(c=='n'))||((prev=='p')&&(c=='p'))||((prev=='v')&&(c=='v'))||((prev=='b')&&(c=='b'))||((prev=='g')&&(c=='g'))||((prev=='l')&&(c=='l'))||((prev=='T')&&(c=='T'))||((prev=='s')&&(c=='s'))||((prev=='d')&&(c=='d'))||((prev=='y')&&(c=='y')))&&(lang==0xB80)) 
       { if(prevprev!=prev)
        { 
           TrinketKeyboard.poll();
           Serial.print("Backspace");
          ...
          else if((((prev=='k')||(prev=='g')||(prev=='j')||(prev=='t')||(prev=='d')||(prev=='n')||(prev=='m')||(prev=='T')||(prev=='D')||(prev=='y')||(prev=='r')||(prev=='l')||(prev=='v')||(prev=='w')||(prev=='s')||(prev=='p')||(prev=='f')||(prev=='h'))&&((c=='k')||(c=='g')||(c=='j')||(c=='t')||(c=='d')||(c=='n')||(c=='m')||(c=='T')||(c=='D')||(c=='y')||(c=='r')||(c=='l')||(c=='v')||(c=='w')||(c=='s')||(c=='p')||(c=='f')||(c=='h'))&&(prev!=c))&&(lang==0xB80)) //for pra
         {
            TrinketKeyboard.poll();
           Serial.print("Backspace");
           TrinketKeyboard.pressKey(0,KEYCODE_BACKSPACE);
       ...
       TrinketKeyboard.pressKey(0,KEYCODE_BACKSPACE);
        ...
        prev=c;
         ...
         if(prev=='c'&&c=='b'&&lang==0x900)
         {
          ...
          if(((prev=='k')||(prev=='g')||(prev=='j')||(prev=='t')||(prev=='d')||(prev=='n')||(prev=='m')||(prev=='T')||(prev=='D')||(prev=='y')||(prev=='r')||(prev=='l')||(prev=='v')||(prev=='w')||(prev=='s')||(prev=='p')||(prev=='f')||(prev=='h')||(prev=='b'))&&((c=='b')||(c=='k')||(c=='g')||(c=='j')||(c=='t')||(c=='d')||(c=='n')||(c=='m')||(c=='T')||(c=='D')||(c=='y')||(c=='r')||(c=='l')||(c=='v')||(c=='w')||(c=='s')||(c=='p')||(c=='f')||(c=='h'))&&(prev!=c))
           {
              
             if((lang==0xB00)||(lang==0xC80))   //for oriya and kannada
           { TrinketKeyboard.poll();
           Serial.print("Backspace");
           TrinketKeyboard.pressKey(0,KEYCODE_BACKSPACE);
           TrinketKeyboard.pressKey(0,0);
           ...
           if(lang==0xA00)   //special case for punjabi
           {
             sendunic(0x0A71);
             com1[0]=c;
             String str=com1;
