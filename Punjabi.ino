  ...
  TrinketKeyboard.pressKey(0,0);
    ...
    TrinketKeyboard.pressKey(0,0);
       ...
       {  pri[l++]=c; 
         ...
         l=0;
         // buf[l++]=c;
          if(((prev=='k')||(prev=='d')||(prev=='g')||(prev=='t')||(prev=='p')||(prev=='b')||(prev=='T')||(prev=='D')||(prev=='j')||(prev=='s')||(prev=='c'))&&(c=='h'))
          { com[0]=prev;
            com[1]=c;
            String str=com;
            TrinketKeyboard.poll();
        ...
        TrinketKeyboard.pressKey(0,0);
        if(lang==1)
        {sendunic(0x900+hashMap.getValueOf(str));}
        else if(lang==2)
        {sendunic(0xA00+hashMap.getValueOf(str));}
        prev=c;
          }
         else
